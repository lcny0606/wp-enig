    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
	  ...
	  <?php $wl_theme_options = weblizar_get_options();
		...
		<div class="item">		
          ...
          <img src="<?php echo esc_url($wl_theme_options['slide_image_10']); ?>" class="img-responsive" alt="<?php echo esc_attr($wl_theme_options['slide_title_10']); ?>">
          <?php } else { ?>
          ...
          <div class="container">
            ...
            <a class="enigma_blog_read_btn animated bounceInUp" href="<?php if($wl_theme_options['slide_btn_link_10']!='') { echo esc_url($wl_theme_options['slide_btn_link_10']); } ?>" role="button"><?php echo esc_attr($wl_theme_options['slide_btn_text_10']); ?></a>
			  <?php } ?>
            </div>
